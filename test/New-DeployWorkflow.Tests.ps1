Describe "New-DeployWorkflow" {
    BeforeAll {
        . "$PSScriptRoot/../src/Private/ConvertFrom-RepoDescription.ps1"
        . "$PSScriptRoot/../src/Private/Test-RepoDescription.ps1"
        . "$PSScriptRoot/../src/Private/Get-TemplateVersion.ps1"
        . "$PSScriptRoot/../src/Private/Get-TemplateHash.ps1"
        . "$PSScriptRoot/../src/Private/Resolve-RepoStack.ps1"
        . "$PSScriptRoot/../src/Private/Get-RepoDeployStatus.ps1"
        . "$PSScriptRoot/../src/Functions/Get-RepoInfo.ps1"
        . "$PSScriptRoot/../src/Functions/New-DeployWorkflow.ps1"
    }
