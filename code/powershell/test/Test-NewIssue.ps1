...
Write-Host "📦 Recargando módulo macss-devops..." -ForegroundColor Yellow
...
$exampleFile = Join-Path $moduleRoot "Resources\New-Issue\examples\bug-pingcontroller.md"
...
$readmePath = Join-Path $moduleRoot "Resources\New-Issue\README.md"
